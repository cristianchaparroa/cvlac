...
/**
  ...
  * la página  del grupo de Investigación GIIRA.
  * 
  * @author: Cristian Camilo Chaparro A.
  */
class PageCVLACScraper extends  CVLACScraper
{
	  /**
	  ...
	  {
       CVLACScraper::__construct( 'http://scienti1.colciencias.gov.co:8080/gruplac/jsp/visualiza/visualizagr.jsp?nro=00000000001394' );
	  }
    /**
    ...
    */
     ...
     * @return Nombre del programa.
    */
    public function programaNacionalCTS(){
